...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Muscle'
        db.create_table(u'exercises_muscle', (
        ...
        db.send_create_signal(u'exercises', ['Muscle'])
        ...
        # Adding model 'Excercise'
        db.create_table(u'exercises_excercise', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('main_muscle', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['exercises.Muscle'])),
            ('equipment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['exercises.Equipment'], null=True, blank=True)),
            ('difficulty', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ...
        db.send_create_signal(u'exercises', ['Excercise'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Excercise'
        db.delete_table(u'exercises_excercise')

        # Deleting model 'ExcerciseHistory'
        db.delete_table(u'exercises_excercisehistory')
